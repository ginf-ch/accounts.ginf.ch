...
foreach ($steps as $stepKey => $stepValue) {
    ...
    ?>
    <section class="hero is-fullheight<?php echo $bgCssClass; ?>" id="edu-<?php echo "$stepNumber" ?>">
        <div class="hero-body">
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-offset-1-tablet is-5-tablet"
                        ...
                        <figure class="has-text-centered js-modal-trigger is-clickable"
                                data-target="<?php echo "step_" . $stepNumber; ?>">
                            <img class="tutorial-img"
                                 src="images/edu/<?php echo $imagePrefix; ?>_jetbrains_account_edu.png"
                                 alt="<?php echo "step_" . $stepNumber; ?>">
                        </figure>
                    </div>
